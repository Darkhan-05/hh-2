...
<body class="font-sans antialiased ">
    <div class="h-screen grid grid-rows-[auto_1fr_auto]">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <a href="{{ route('vacancies') }}"
                                class="inline-block w-full py-2 mx-0 font-medium text-left text-gray-700 md:w-auto md:px-0 md:mx-2 hover:text-indigo-600 lg:mx-3 md:text-center">Vacancies</a>
                            <a href="#_"
        ...
        <section class="h-auto bg-white">
            <div class="px-10 py-16 m-auto max-w-7xl my-36 sm:py-24 sm:px-6 lg:px-8 sm:text-center">
                <h2 class="text-base font-semibold tracking-wide text-indigo-600 uppercase">subtitle text</h2>
                ...
                <p class="max-w-3xl mx-auto mt-5 text-xl text-gray-500">Are you ready to start building the next great idea. You can start off by using our design components to help tell you story and showcase your great idea.</p>
            </div>
        </section>
        <section class="bg-white">
            <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                <nav class="flex flex-wrap justify-center -mx-5 -my-2">
                    <div class="px-5 py-2">
                        <a href="#" class="text-base leading-6 text-gray-500 hover:text-gray-900">О нас</a>
                    </div>
                    <div class="px-5 py-2">
                        <a href="#" class="text-base leading-6 text-gray-500 hover:text-gray-900">Блог</a>
                    </div>
                    <div class="px-5 py-2">
                        <a href="#" class="text-base leading-6 text-gray-500 hover:text-gray-900">Команда</a>
                    </div>
                    <div class="px-5 py-2">
                        <a href="#" class="text-base leading-6 text-gray-500 hover:text-gray-900">Цены</a>
                    </div>
                    <div class="px-5 py-2">
                        <a href="#" class="text-base leading-6 text-gray-500 hover:text-gray-900">Контакты</a>
                    </div>
                    <div class="px-5 py-2">
                        <a href="#" class="text-base leading-6 text-gray-500 hover:text-gray-900"></a>
                    </div>
                </nav>
